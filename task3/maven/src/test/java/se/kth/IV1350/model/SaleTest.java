...
public class SaleTest {
    ...
    void testAddNewItemToSale(){
        ...
        // Simulating items created in a DB 
        for(int i = 1; i<5;i++){
    ...
    void testAddExistingItemToSale(){
        ...
        // Get a specifc item that already eixst in the simualted DB
    ...
    void testEndSaleSuccess(){
        ...
        assertEquals(payemnt.getTotalAmountPaid(), amount, "The wrong amount is stored in the class");
        assertEquals(payemnt.getTotalChange(), amount - saleInstance.getTotalPriceAfterDiscount().getValue(), "The total change is not calculated correctly");
